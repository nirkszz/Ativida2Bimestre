...
public class CarAddForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        addCarLabel.setText("Adicionar Automovel");

        carNumLabel.setText("Placa do Veiculo");

        carBrandLabel.setText("Marca do Veiculo");

        carModelLabel.setText("Modelo do Veiculo");

        carPriceLabel.setText("Vaga");

        addCarButton.setText("Adicionar Veiculo");
